...
import { SubscribeGuard } from 'projects/sat-decorators/src/public-api';
...
export class SubscribeGuardComponent //implements OnDestroy
{
  str?: string;
